...
def build_loss(cfg: CN, **kwargs):
    return build_from_cfg(cfg, LOSS, **kwargs)


def build_metric(cfg: CN, **kwargs):
    return build_from_cfg(cfg, METRIC, **kwargs)


def build_transform(cfg: CN, **kwargs):
    return build_from_cfg(cfg, TRANSFORM, **kwargs)
